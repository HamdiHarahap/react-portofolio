	...
	return (
		<>
			...
			>
				...
				<ImageHover
					images={skills}
					imgClass="w-16 mx-auto transition-transform duration-300 group-hover:scale-110"
					containerClass="group bg-[#2d2d39] p-4 rounded-lg relative overflow-hidden cursor-pointer"
					parentClass="flex gap-4 flex-wrap w-[35rem] max-[520px]:w-full max-[520px]:justify-center~"
				/>
			</div>
		</>
	)
